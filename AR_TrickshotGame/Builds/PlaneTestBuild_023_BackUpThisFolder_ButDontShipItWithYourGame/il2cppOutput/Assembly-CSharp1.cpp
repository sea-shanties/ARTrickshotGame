...
IL_0019:
	...
	{
		bool L_4 = __this->___BallTime_32;
		if (!L_4)
		{
			goto IL_0035;
		}
...
IL_0035:
	...
	{
		float L_15 = __this->____swipeDist_9;
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_16 = __this->____ball_5;
		NullCheck(L_16);
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_18 = (&__this->____angle_20);
		float L_19 = L_18->___x_2;
		float L_20 = __this->____ballSpeed_15;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_21 = (&__this->____angle_20);
		float L_22 = L_21->___y_3;
		float L_23 = __this->____ballSpeed_15;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_24 = (&__this->____angle_20);
		float L_25 = L_24->___z_4;
		float L_26 = __this->____ballSpeed_15;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_27;
		memset((&L_27), 0, sizeof(L_27));
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_27), ((float)il2cpp_codegen_multiply(L_19, L_20)), ((float)il2cpp_codegen_multiply(L_22, L_23)), ((float)il2cpp_codegen_multiply(L_25, L_26)), /*hidden argument*/NULL);
		NullCheck(L_17);
		Rigidbody_AddForce_m7A3EEEED21F986917107CBA6CC0106DCBC212198(L_17, L_27, NULL);
		// _ball.GetComponent<Rigidbody>().useGravity = true;
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_28 = __this->____ball_5;
		NullCheck(L_28);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void BallThrow_DefaultBall_mA009A54DCE8C920692E7F324F16F8274A7D6971B (BallThrow_tBC07D1003ACA9F6EB024E09D36DD1DEF21E3F776* __this, const RuntimeMethod* method) 
{
	...
	bool V_0 = false;
	{
		...
		// BallTime = true;
		__this->___BallTime_32 = (bool)1;
		// Tries++;
		int32_t L_6 = __this->___Tries_6;
		__this->___Tries_6 = ((int32_t)il2cpp_codegen_add(L_6, 1));
		// Debug.Log("Tries: " + Tries);
		int32_t* L_7 = (&__this->___Tries_6);
		String_t* L_8;
		L_8 = Int32_ToString_m030E01C24E294D6762FB0B6F37CB541581F55CA5(L_7, NULL);
		String_t* L_9;
		L_9 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(_stringLiteral177C95994BA8FF1EFBD416DA002DAE5B663FDFD2, L_8, NULL);
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
		Debug_Log_m86567BCF22BBE7809747817453CACA0E41E68219(L_9, NULL);
		// _ball.transform.localPosition = _ogBallPos;
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_10 = __this->____ball_5;
		NullCheck(L_10);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_11;
		L_11 = GameObject_get_transform_m0BC10ADFA1632166AE5544BDF9038A2650C2AE56(L_10, NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_12 = __this->____ogBallPos_24;
		NullCheck(L_11);
		...
		int32_t L_16 = 0;
		V_0 = (bool)L_16;
		__this->____holding_22 = (bool)L_16;
		bool L_17 = V_0;
		__this->____thrown_21 = L_17;
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_21 = __this->____ball_5;
		NullCheck(L_21);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void BallThrow_HoldBall_mA5C57CAF9E5FBA5C4AD7E62768833C778F5684EB (BallThrow_tBC07D1003ACA9F6EB024E09D36DD1DEF21E3F776* __this, const RuntimeMethod* method) 
{
	...
	memset((&V_0), 0, sizeof(V_0));
	{
		...
		float L_12 = __this->___RightScreenLimit_28;
	...
	}
	{
		...
		float L_16 = __this->___LeftScreenLimit_29;
	...
	}
	{
		...
		float L_20 = __this->___TopScreenLimit_30;
	...
	}
	{
		...
		float L_24 = __this->___BottomScreenLimit_31;
	...
	}
	{
		...
		float L_31 = __this->___DragSpeed_27;
		float L_32;
...
{
	{
		...
		__this->___Reach_26 = (20.0f);
		// [SerializeField] float DragSpeed = 80;
		__this->___DragSpeed_27 = (80.0f);
		// [SerializeField] float RightScreenLimit = 0.91f;
		__this->___RightScreenLimit_28 = (0.910000026f);
		// [SerializeField] float LeftScreenLimit = 0.09f;
		__this->___LeftScreenLimit_29 = (0.0900000036f);
		// [SerializeField] float TopScreenLimit = 0.925f;
		__this->___TopScreenLimit_30 = (0.925000012f);
		// [SerializeField] float BottomScreenLimit = 0.04f;
		__this->___BottomScreenLimit_31 = (0.0399999991f);
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
